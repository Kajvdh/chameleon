...
class Chatbox {
    ...
    public function readForm($form) {
		...
		// Titledata
		if (isset($form['titledata'])) {
            $this->setTitledata($form['titledata']);
        }
		// View Height
